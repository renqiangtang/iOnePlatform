...
public class StrUtils {
	 ...
	 * //非正整数（负整数 + 0） "^-[0-9]*[1-9][0-9]*$" //负整数 "^-?\d+$" //整数
	 * "^\d+(\.\d+)?$" //非负浮点数（正浮点数 + 0）
	 * "^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1
	 * -9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$" //正浮点数
	 * "^((-\d+(\.\d+)?)|(0+(\.0+)?))$" //非正浮点数（负浮点数 + 0）
	 * "^(-(([0-9]+\.[0-9]*[1-
	 * 9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*)))$" //负浮点数
	 * "^(-?\d+)(\.\d+)?$" //浮点数 "^[A-Za-z]+$" //由26个英文字母组成的字符串 "^[A-Z]+$"
	 * //由26个英文字母的大写组成的字符串 "^[a-z]+$" //由26个英文字母的小写组成的字符串 "^[A-Za-z0-9]+$"
	 * //由数字和26个英文字母组成的字符串 "^\w+$" //由数字、26个英文字母或者下划线组成的字符串
	 * "^[\w-]+(\.[\w-]+)*@[\w-]+(\.[\w-]+)+$" //email地址
	 ...
	 * ^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])
	 * -(0?[1-9]|[12]\d|3[01]))|(((1[
	 * 6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0
	 * ?[1-9]|[12]\d|30))|(((1[6-9]|[
	 * 2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-8]))|(((1
	 ...
	 * 
	 * @param s
	 *            需检查的字符串。格式：yyyy-MM-dd HH:mm:ss
	 * @return true日期
	 */
	public static boolean isDateTime(String s) {
		...
		// return
		// s.matches("^(?ni:(?=\\d)((?'year'((1[6-9])|([2-9]\\d))\\d\\d)(?'sep'[/.-])(?'month'0?[1-9]|1[012])\\2(?'day'((?<!(\\2((0?[2469])|11)\\2))31)|(?<!\\2(0?2)\\2)(29|30)|((?<=((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|(16|[2468][048]|[3579][26])00)\\2\\3\\2)29)|((0?[1-9])|(1\\d)|(2[0-8])))(?:(?=\\x20\\d)\\x20|$))?((?<time>((0?[1-9]|1[012])(:[0-5]\\d){0,2}(\\x20[AP]M))|([01]\\d|2[0-3])(:[0-5]\\d){1,2}))?)$");
		else
			return false;
	}
	...
	public static int lastIndexOfIgnoreCase(String parent, String child,
		...
		fromIndex = fromIndex >= parent.length() ? parent.length() - 1
				: fromIndex;
	 ...
	 * 
	 * @param parent
	 *            父字符串。如"abc=123;xyz=666;mnq=888"字符串
	 * @param ignoreCase
	 *            true参数名忽略大小写，忽略大小写后返回的参数名都为小写
	 * @param equals
	 *            键与值之间的等于字符串，传空则使用“=”。等于符大小写必须一致，即不受ignoreCase参数影响
	 * @param split
	 *            键值对之间的分隔符，传空则使用“;”。分隔符大小写必须一致，即不受ignoreCase参数影响
	 * @return 键值对MAP
	 */
	public static Map<String, String> getParams(String parent,
			boolean ignoreCase, String equals, String split) {
		if (isNull(parent)) {
			return null;
		}
		...
		/*
		 * //split方法使用的是正则表达式，故部分特殊字符不能正常工作，必须使用通配符 String[] aryParams =
		 * parent.split(strSplit); for(String strParam: aryParams) { if
		 * (ignoreCase) params.put(strParam.substring(0,
		 * strParam.indexOf(strEquals)).toLowerCase(),
		 * strParam.substring(strParam.indexOf(strEquals) + strEquals.length(),
		 * strParam.length())); else params.put(strParam.substring(0,
		 * strParam.indexOf(strEquals)),
		 * strParam.substring(strParam.indexOf(strEquals) + strEquals.length(),
		 * strParam.length())); }
		 */
		...
		do {
			...
			if (intPos >= 0) {
				...
				if (!isNull(strParam)) {
					...
					String strParamName = intEqualsPos >= 0 ? strParam
							.substring(0, intEqualsPos) : strParam;
					String strParamValue = intEqualsPos >= 0 ? strParam
							.substring(intEqualsPos + strEquals.length(),
									strParam.length()) : "";
					params.put(ignoreCase ? strParamName.toLowerCase()
	 ...
	 */
	public static Map<String, String> getParams(String parent,
			boolean ignoreCase, String equals) {
	...
	public static boolean paramExists(String parent, String paramName,
		...
		Map<String, String> params = getParams(parent, ignoreCase, equals,
				split);
		return ignoreCase ? params.containsKey(paramName.toLowerCase())
	 ...
	 *            父字符串。如"abc=123;xyz=666;mnq=888"字符串
	 * @param paramName
	 *            参数名。上例传入paramName="xyz"返回"666"。不存在返回""，非null
	 * @param ignoreCase
	 *            是否忽略大小写。注意如果忽略大小写(true)将把所有的key转换为小写
	 * @param equals
	 *            键与值之间的等于字符串，传空则使用“=”。等于符大小写必须一致，即不受ignoreCase参数影响
	 * @param split
	 *            键值对之间的分隔符，传空则使用“;”。分隔符大小写必须一致，即不受ignoreCase参数影响
	 ...
	 *            键值对之间的分隔符，传空则使用“;”。分隔符大小写必须一致，即不受ignoreCase参数影响
	 * @return 
	 *         返回写入参数的新串，原串不修改。如写入"abc=123;xyz=666;mnq=888"字符串中的某项的值,如paramName="xyz"
	 *         ,paramValue="XXX"返回"abc=123;xyz=XXX;mnq=888"
	 */
	public static String setParamValue(String parent, String paramName,
			String paramValue, boolean ignoreCase, String equals, String split) {
		if (isNull(paramName)) {
			return parent;
		}
		String strEquals = isNull(equals) ? "=" : equals;
		...
		int intPos = ignoreCase ? indexOfIgnoreCase(strParent, strSplit
				+ paramName + strEquals) : strParent.indexOf(strSplit
				+ paramName + strEquals);
		String result;
		if (intPos >= 0) {
			String leftStr = parent.substring(0, intPos + paramName.length()
					+ strEquals.length());
			String rightStr = parent.substring(intPos + paramName.length()
					+ strEquals.length(), parent.length());
			if (rightStr.indexOf(strSplit) >= 0)
				rightStr = rightStr.substring(rightStr.indexOf(strSplit),
						rightStr.length());
			else
				rightStr = "";
			result = leftStr + paramValue + rightStr;
		} else {
			intPos = ignoreCase ? indexOfIgnoreCase(strParent, strSplit
					+ paramName + strSplit) : strParent.indexOf(strSplit
					+ paramName + strSplit);
			if (intPos >= 0) {
				String leftStr = parent.substring(0, intPos);
				String rightStr = intPos + paramName.length()
						+ strSplit.length() > parent.length() ? "" : parent
						.substring(intPos + paramName.length()
								+ strSplit.length());
				result = leftStr + paramName + strEquals + paramValue
						+ strSplit + rightStr;
			} else
	 ...
	 */
	public static String setParamValue(String parent, String paramName,
			String paramValue, boolean ignoreCase, String equals) {
	 ...
	 */
	public static String setParamValue(String parent, String paramName,
			String paramValue, boolean ignoreCase) {
	...
	public static String deleteParam(String parent, String paramName,
		...
		if (intPos >= 0) {
			...
			String rightStr = parent.substring(intPos + paramName.length()
					+ strEquals.length(), parent.length());
			rightStr = rightStr.indexOf(strSplit) >= 0 ? rightStr.substring(
					rightStr.indexOf(strSplit) + strSplit.length(),
					rightStr.length()) : "";
			if (isNull(rightStr))
				return leftStr.substring(0, leftStr.length() - 1);
			else
			...
			intPos = ignoreCase ? indexOfIgnoreCase(strParent, strSplit
					...
					+ paramName + strSplit);
			if (intPos >= 0) {
				if (intPos + paramName.length() + strSplit.length() > parent
						.length()) {
					return parent.substring(0, intPos - 1);
				} else {
					String leftStr = parent.substring(0, intPos);
					String rightStr = parent.substring(
							intPos + paramName.length() + strSplit.length(),
							parent.length());
					return leftStr + rightStr;
				}
			} else
	 ...
	 * @return 返回删除参数后的串，不会修改原串
	 */
	public static String deleteParam(String parent, int paramIndex,
			String equals, String split) {
		if (isNull(parent) || paramIndex < 0) {
			return parent;
		}
		String strEquals = isNull(equals) ? "=" : equals;
		String strSplit = isNull(split) ? ";" : split;
		String param = getSubStr(parent, strSplit, paramIndex);
		String paramName = null;
		if (param.indexOf(strEquals) >= 0)
			paramName = getSubStr(param, strEquals, 0);
		else
			paramName = param;
		return deleteParam(parent, paramName, false, equals, split);
	}
	...
	public static String deleteParam(String parent, int paramIndex,
			String equals) {
		return deleteParam(parent, paramIndex, equals, null);
	}

	/**
	 * 在父串中删除参数，参数值等于符为“=”，分隔符为“;”
	 * 
	 * @param parent
	 *            父串
	 * @param paramIndex
	 ...
	 */
	public static String deleteParam(String parent, int paramIndex) {
		return deleteParam(parent, paramIndex, null);
	}
	...
	public static String getRightString(String parent, int rightLength) {
		if (isNull(parent)) {
			...
			if (parent.length() <= rightLength) {
				...
				return parent.substring(parent.length() - rightLength,
						parent.length());
			}
		}
	}
	...
	public static int getSubStrCount(String parent, String child,
		...
		int start = 0;
		if (ignoreCase) {
			while (indexOfIgnoreCase(parent, child, start) >= 0
					&& start < parent.length()) {
				count++;
				start = indexOfIgnoreCase(parent, child, start)
						+ child.length();
			}
		} else {
	...
	public static List<String> getSubStrs(String parent, String split,
		...
		int intStart = 0;
		do {
			intPos = ignoreCase ? indexOfIgnoreCase(strParent, split, intStart)
					: strParent.indexOf(split, intStart);
			if (intPos >= 0) {
	...
	/**
	 * 日期转字符串，转换格式按yyyy-MM-dd HH:mm:ss
	 * 
	 * @param date
	 *            日期
	 * @return
	...
	/**
	 * 字符串转日期，转换格式按yyyy-MM-dd HH:mm:ss
	 * 
	 * @param date
	 *            字符串格式日期
	 * @return
	 ...
	 *            字符串格式日期
	 * @param dateFormat
	 *            判断是否符合的日期格式，yyyy-MM-dd HH:mm:ss
	 * @return
	 */
	...
	/**
	 * 字符串日期是否符合指定日期格式，日期格式按yyyy-MM-dd HH:mm:ss
	 * 
	 * @param date
	 *            字符串格式日期
	 * @return
	...
	public static boolean isDateFormat(String date) {
		return isDateFormat(date, "yyyy-MM-dd HH:mm:ss");
	}
	 ...
	 */
	public static boolean equals(String s1, String s2, boolean ignoreCase) {
		return equals(s1, s2, ignoreCase, false);
	}

	/**
	 * 判断两字符串是否相等（区分大小写），如果都为null时返回false
	 * 
	 * @param s1
	 *            字符串1
	 * @param s2
	...
	public static boolean equalsIgnoreCase(String s1, String s2,
			boolean nullEqual) {
		return equals(s1, s2, true, nullEqual);
	}

	/**
	 * 判断两字符串是否相等(不区分大小写)，如果都为null时返回false
	 * 
	 * @param s1
	 *            字符串1
	 * @param s2
	 ...
	 */
	public static boolean equalsIgnoreCase(String s1, String s2) {
		return equalsIgnoreCase(s1, s2, false);
	}

	/**
	 * 解析出oracle抛出的错误信息中有用的错误信息
	 * 
	 * @param s
	 *            错误信息串
	 * @return
	 */
	public static String parseOracleErrorMessage(String s) {
		if (isNull(s))
			return s;
		if (s.indexOf("ORA-") >= 0) {
			// ORA-20001: 需要重拍的标的（00230000000000000000000000000727）已经重拍过，重拍操作取消
			// ORA-06512: 在 "TRANSACTION_SZ.COPY_TARGET", line 66 ORA-06512: 在
			// line 1 。
			// 转换为：
			// 需要重拍的标的（00230000000000000000000000000727）已经重拍过，重拍操作取消
			String result = getSubStr(s, "ORA-", 1);
			result = getSubStr(result, ": ", 1);
			return result;
		} else
			return s;
	}
	...
	public static String redefineScript(String json) {
		String value = json;
		String tagBegin = "<script>";
		String tagEnd = "<\\/script>";
		int begin = json.indexOf(tagBegin, 0);
		int end = json.indexOf(tagEnd, begin + tagBegin.length());
		while (begin >= 0 && end > begin) {
			value = StringUtils.replaceOnce(value, tagBegin, "<_script>");
			value = StringUtils.replaceOnce(value, tagEnd, "</_script>");
			begin = value.indexOf(tagBegin, end);
			end = value.indexOf(tagEnd, tagBegin.length());
		}
	...
	public static void main(String[] args) {
		System.out.println(StrUtils.deleteParam("land;house;mineral;plow", 0));
		System.out.println(StrUtils.deleteParam("land;house;mineral;plow", 1));
		System.out.println(StrUtils.deleteParam(
				"land=0;house=1;mineral=2;plow=3", 0));
		System.out.println(StrUtils.deleteParam(
				"land=0;house=1;mineral=2;plow=3", 1));
		System.out.println(StrUtils.deleteParam("land;house;mineral;plow", 3));
		System.out.println(StrUtils.deleteParam(
				"land=0;house=1;mineral=2;plow=3", 3));
		// System.out.println(StrUtils.setParamValue("land;house;mineral;plow",
		// "plow", "3"));
		// System.out.println(StrUtils.setParamValue("land;house;mineral;plow",
		// "house", "1"));
		// System.out.println(StrUtils.setParamValue("land=0;house=1;mineral=2;plow=3",
		// "plow", "x"));
		// System.out.println(StrUtils.setParamValue("land=0;house=1;mineral=2;plow=3",
		// "house", "y"));
	}
