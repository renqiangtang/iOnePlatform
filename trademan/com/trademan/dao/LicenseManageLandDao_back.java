 ...
 * 2012-05-11
 */
public class LicenseManageLandDao_back extends BaseDao {
	...
	public ParaMap deleteLicenseData(String moduleId, String dataSetNo, String id) throws Exception {
		...
		if (result.getInt("state") == 1) {
			...
			transLicenseDao.updateCartDtl(bidderId , targetId , 2, 1 , null);
		}
		return result;
	}
	...
	public static void main(String[] args) throws Exception {
		LicenseManageLandDao_back licenseManageDao = new LicenseManageLandDao_back();
