...
// 是否显示多指标列
// ---------------------------------
pageObj.showMultiTradeCol = false;
pageObj.showStatusCol = false;
// ---------------------------------
// 表格初始宽高
// ---------------------------------
...
//	}
	...
	var url = approot + '/data?module=tradeland&service=OfferLog&method=getOfferLogListData&moduleId=' + pageObj.moduleId + '&u=' + pageObj.userId;
	if (pageObj.targetId) {
...
pageObj.queryData = function() {
	...
	var url = approot + '/data?module=tradeland&service=OfferLog&method=getOfferLogListData&moduleId=' + pageObj.moduleId;
...
pageObj.viewOfferLog = function(offerLogId) {
	DialogOpen({
		height : 750,
		width : 1000,
		url : approot + '/land/trade/viewOfferLog.html?offerLogId=' + offerLogId,
		title : '查看竞买报价',
		buttons : [ {
			text : '关闭',
...
//	alert("bidderId = " + pageObj.bidderId);
//	alert("licenseId = " + pageObj.licenseId);
//	alert("targetId = " + pageObj.targetId);
