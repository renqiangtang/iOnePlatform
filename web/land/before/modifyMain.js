...
pageObj.editHtml['地块'] = '101.html';
pageObj.editHtml['探矿权'] = '301.html';
pageObj.editHtml['采矿权'] = '301.html';
...
pageObj.cancel = function(infoType, id, goodsType) {
	DialogConfirm('确定要撤销该公告?', function(yn) {
		if (!yn)
			return;
		var cmd = new Command("before", "TransModify", "cancelNotice");
		cmd.noticeId = id;
...
pageObj.initPage = function() {
	var url = approot + '/data?module=before&service=TransModify&method=getDatas&goodsType='+pageObj.goodsType;
