...
pageMainObj.viewLicenseList = function() {
	...
	if (mainFrame) {
		...
		if (mainFrame) {
			mainFrame.src = approot +"/"+comObj.urlPath[pageMainObj.goodsType]+"/bidder/licenseList.html";
		}
	}
}
...
pageMainObj.initHtml = function() {
	...
	$('#noticeTargets').click(function() {
				parent.document.getElementById('framePage').src = approot + "/land/bidder/productList.html?goodsType=101";
			});
	var mainFrame = getMainFrame(window);
