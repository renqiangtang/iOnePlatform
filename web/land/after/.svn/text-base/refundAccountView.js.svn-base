...
//		if(target_status=='0'){
//			$("#target_status").html('受理中');
//		}else if(target_status=='1'){
//			$("#target_status").html('审核中');
//		}else if(target_status=='2'){
//			$("#target_status").html('已审核');
//		}else if(target_status=='3'){
//			$("#target_status").html('已公告');
//		}else if(target_status=='4'){
//			$("#target_status").html('交易中');
//		}else if(target_status=='5'){
//			$("#target_status").html('已成交');
//		}else if(target_status=='6'){
//			$("#target_status").html('未成交(流拍)');
//		}
