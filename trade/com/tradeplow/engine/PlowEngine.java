...
public class PlowEngine {
	...
	public boolean getEngineState() {
		return EngineManageDao.engineStarted(Engine.Type_Plow);
	}
	...
	private ParaMap startEngine() throws Exception {
		ParaMap map = engineDao.getNotEndProcess("'501'");
	 ...
	 * @throws Exception
	 */
	public void next(ParaMap context) throws Exception {
		//
		// if(!engineDao.isDoBeginNext(context.getString("processid"))){
		// return;
		// }
		NodeHandle handle = engineDao.getHandle(context);
		if (handle != null) {
