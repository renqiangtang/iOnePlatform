...
import com.trademine.dao.ViewTargetMineDao;
 ...
 */
public class ViewTargetMineService extends BaseService {
	public ParaMap getTargetData(ParaMap inMap) throws Exception {
		ViewTargetMineDao viewTargetDao = new ViewTargetMineDao();
		...
		TransGoodsMineDao dao = new TransGoodsMineDao();
