 ...
 */
public class TransGoodsLandService extends BaseService {
	...
	public ParaMap saveTransGoods(ParaMap inMap) throws Exception {
		...
		String organId = this.getOrganId(userId);
		//土地
		String range = inMap.getString("range");// 四至范围
		String land_area = inMap.getString("land_area");// 出让面积
		String industry_type = inMap.getString("industry_type");// 产业类别
		String use_years = inMap.getString("use_years");// 使用年限
		String provide_date = inMap.getString("provide_date");// 供地时间
		String media = inMap.getString("media");// 公告媒体
		String develop = inMap.getString("develop");// 开发强度
		//
		String build_height = inMap.getString("build_height");// 建筑高度
		String build_height2 = inMap.getString("build_height2");// 建筑高度2
		String plot1_down = inMap.getString("plot1_down");// 地上容积率 down
		String plot1_up = inMap.getString("plot1_up");// 地上容积率 up
		String build_density_down = inMap.getString("build_density_down");// 建筑密度
																			// down
		String build_density_flag = inMap.getString("build_density_flag");// 建筑密度
																			// flag
		String build_density_up = inMap.getString("build_density_up");// 建筑密度 up
		String plot2_down = inMap.getString("plot2_down");// 地下容积率 down
		String plot2_up = inMap.getString("plot2_up");// 地下容积率 up
		String green_ratio_down = inMap.getString("green_ratio_down");// 绿化率
																		// down
		String green_ratio_flag = inMap.getString("green_ratio_flag");// 绿化率
																		// flag
		String green_ratio_up = inMap.getString("green_ratio_up");// 绿化率 down
		String stop_ratio = inMap.getString("stop_ratio");// 停车率
		String stop_ratio_down = inMap.getString("stop_ratio_down");// 停车率 down
		String stop_ratio_flag = inMap.getString("stop_ratio_flag");// 停车率
		String stop_ratio_up = inMap.getString("stop_ratio_up");// 停车率 up
		String positionxy = inMap.getString("positionxy");// 坐标
		String startRequired = inMap.getString("startRequired");// 开工要求
		String otherCondition = inMap.getString("otherCondition");// 其它条件
		//矿产
		...
		String build_area=inMap.getString("build_area");//建筑面积
		...
		String limitup=inMap.getString("limitup");//限高（米）
		String limitdown=inMap.getString("limitdown");//限低（米）
		String transLandTypeValue=inMap.getString("transLandTypeValue");//建设用地类型
		//以下是页面那些符号
		String plot1_flag=inMap.getString("plot1_flag");
		String build_density1_flag=inMap.getString("build_density1_flag");
		String build_height1_flag=inMap.getString("build_height1_flag");
		String green_ratio1_flag=inMap.getString("green_ratio1_flag");
		
		String plot2_flag=inMap.getString("plot2_flag");
		String build_density2_flag=inMap.getString("build_density2_flag");
		String build_height2_flag=inMap.getString("build_height2_flag");
		String green_ratio2_flag=inMap.getString("green_ratio2_flag");
		...
		//根据organId查询出这个单位属于什么区域
		ParaMap cantonMap=new ParaMap();
		cantonMap.put("id", organId);
		DataSetDao cantonDao=new DataSetDao();
	    ParaMap cantonOut=cantonDao.querySimpleData("sys_organ", cantonMap);
	    List items = MakeJSONData.makeItems(cantonOut);
	    String canton_outId="";
	    if(cantonOut.getSize()>0){
	    	canton_outId=((ParaMap)items.get(0)).getString("canton_id");
	    	goodsMap.put("canton_id", canton_outId);
	    }
		goodsMap.put("no", no);
		...
		if (StringUtils.isNotEmpty(goodsId)) {
			...
			//
			if(goods_type.equals("101")){
				transGoodsDao.updateExtend("trans_goods", goodsId, "industry_type",
						industry_type, "产业类别");
				transGoodsDao.updateExtend("trans_goods", goodsId, "provide_date",
						provide_date, "供地时间");
				transGoodsDao.updateExtend("trans_goods", goodsId, "use_years",
						use_years, "使用年限");
				transGoodsDao.updateExtend("trans_goods", goodsId, "media", media,
						"公告媒体");
				transGoodsDao.updateExtend("trans_goods", goodsId, "develop",
						develop, "开发强度");
				transGoodsDao.updateExtend("trans_goods", goodsId, "land_area",
						land_area, "出让面积");
				transGoodsDao.updateExtend("trans_goods", goodsId, "build_height",
						build_height, "建筑高度");
				transGoodsDao.updateExtend("trans_goods", goodsId, "build_height2",
						build_height, "建筑高度2");
				
				transGoodsDao.updateExtend("trans_goods", goodsId, "plot1_down",
						plot1_down, "地上容积率 down");
				transGoodsDao.updateExtend("trans_goods", goodsId, "plot1_flag",
						plot1_flag, "地上容积率操作符");
				transGoodsDao.updateExtend("trans_goods", goodsId, "plot1_up",
						plot1_up, "地上容积率 up");//
				transGoodsDao.updateExtend("trans_goods", goodsId,
						"build_density_down", build_density_down, "建筑密度 down");
				transGoodsDao.updateExtend("trans_goods", goodsId,
						"build_density_flag", build_density_flag, "建筑密度操作符");
				transGoodsDao.updateExtend("trans_goods", goodsId,
						"build_density_up", build_density_up, "建筑密度 up");
				transGoodsDao.updateExtend("trans_goods", goodsId, "plot2_down",
						plot2_down, "地下容积率 down");
				transGoodsDao.updateExtend("trans_goods", goodsId, "plot2_flag",
						plot2_flag, "地下容积率操作符");
				transGoodsDao.updateExtend("trans_goods", goodsId, "plot2_up",
						plot2_up, "地下容积率 up");
				transGoodsDao.updateExtend("trans_goods", goodsId,
						"green_ratio_down", green_ratio_down, "绿化率 down");
				transGoodsDao.updateExtend("trans_goods", goodsId,
						"green_ratio_flag", green_ratio_flag, "绿化率 flag");
				transGoodsDao.updateExtend("trans_goods", goodsId,
						"green_ratio_up", green_ratio_up, "绿化率 up");
				transGoodsDao.updateExtend("trans_goods", goodsId, "stop_ratio",
						stop_ratio, "停车率");
				transGoodsDao.updateExtend("trans_goods", goodsId,
						"stop_ratio_down", stop_ratio_down, "停车率 down");
				transGoodsDao.updateExtend("trans_goods", goodsId,
						"stop_ratio_flag", stop_ratio_flag, "停车率 flag");
				transGoodsDao.updateExtend("trans_goods", goodsId, "stop_ratio_up",
						stop_ratio_up, "停车率 up");
				transGoodsDao.updateExtend("trans_goods", goodsId, "positionxy",
						positionxy, "坐标");
				transGoodsDao.updateExtend("trans_goods", goodsId, "startRequired",
						startRequired, "开工要求");
				transGoodsDao.updateExtend("trans_goods", goodsId, "range", range,
						"四至范围");
				transGoodsDao.updateExtend("trans_goods", goodsId,"otherCondition", otherCondition, "其它条件");
				transGoodsDao.updateExtend("trans_goods", goodsId,"build_area", build_area, "建筑面积");
				...
				transGoodsDao.updateExtend("trans_goods", goodsId,"limitup", limitup, "限高(米)");
				transGoodsDao.updateExtend("trans_goods", goodsId,"limitdown", limitdown, "限低(米)");
				transGoodsDao.updateExtend("trans_goods", goodsId,"transLandTypeValue", transLandTypeValue, "建设用地类型");
				
				
				transGoodsDao.updateExtend("trans_goods", goodsId,"build_density1_flag", build_density1_flag, "建筑密度1");
				transGoodsDao.updateExtend("trans_goods", goodsId,"build_density2_flag", build_density2_flag, "建筑密度2");
				transGoodsDao.updateExtend("trans_goods", goodsId,"build_height1_flag", build_height1_flag, "建筑高度1");
				transGoodsDao.updateExtend("trans_goods", goodsId,"build_height2_flag", build_height2_flag, "建筑高度2");
				transGoodsDao.updateExtend("trans_goods", goodsId,"green_ratio1_flag", green_ratio1_flag, "绿地率1");
				transGoodsDao.updateExtend("trans_goods", goodsId,"green_ratio2_flag", green_ratio2_flag, "绿地率2");
	...
	public ParaMap getOtherTargetGoodsList(ParaMap inMap) throws Exception {
		...
		if (StrUtils.isNotNull(goods_type)) {
			sql = " and tg.goods_type = :goods_type ";
			sqlParam.put("goods_type", goods_type);
		}
		if (StrUtils.isNotNull(canton_id)) {
	...
	public ParaMap getTransGoodsData(ParaMap inMap) throws Exception {
		...
		if (StringUtils.isNotEmpty(goodsId)) {
			...
			extendMap.clear();
			extendMap = dataSetDao.querySimpleData("sys_extend",
					keyData);
			if (extendMap.getSize() > 0) {
				List filds = extendMap.getFields();
				for (int i = 0; i < extendMap.getSize(); i++) {
			...
			data.put("noticeConfirmData", noticeConfirmData);
		}
		return data;
	}
					...
					for (int i = 0; i < extendMap.getSize(); i++) {
						...
						if (filds != null && filds.size() > 0) {
							for (int j = 0; j < filds.size(); j++) {
								if ("field_no".equals((String) filds.get(j))) {
									field_no = (String) record.get(j);
								} else if ("field_value".equals((String) filds
										.get(j))) {
									field_value = (String) record.get(j);
								}
							}
						...
						if (!field_no.equals("")) {
							((ParaMap) targetList.get(0)).put(field_no,
									field_value);
						}
					}
				}
		...
		if (StringUtils.isNotEmpty(targetId)) {
			...
			if (tradeMap.getSize() > 0) {
				...
				for (int i = 1; i < tradeMap.getSize(); i++) {
					...
					if(pm.get("unit")!=null && pm.get("unit").equals("万元")){
						if(pm.get("final_value") !=null && pm.get("final_value")!=""){
							float final_value=(Float.parseFloat(String.valueOf(pm.get("final_value"))))/10000;
							pm.put("final_value", final_value);
						}
						if(pm.get("init_value") !=null && pm.get("init_value")!=""){
							float init_value=(Float.parseFloat(String.valueOf(pm.get("init_value"))))/10000;
							pm.put("init_value", init_value);
						}
						if(pm.get("step") !=null && pm.get("step")!=""){
							float step=(Float.parseFloat(String.valueOf(pm.get("step"))))/10000;
							pm.put("step", step);
						}
	...
	public ParaMap saveTransTarget(ParaMap inMap) throws Exception {
		...
		String pay_mode = inMap.getString("pay_mode");//付款方式
		String mode = inMap.getString("mode");
		...
		//标地保存没有出错，则保存他的扩展字段   pay_mode付款方式
		if(targetId!=null && !targetId.equals("")){
			transGoodsDao.updateExtend("trans_target", targetId, "pay_mode", pay_mode,
					"付款方式");
		}
					...
					if (json != null && json.size() > 0) {
						for (int i = 0; i < json.size(); i++) {
							...
							if (type != null && !type.equals("Q01")) {
								...
								if(jsonObj.get("unit").toString().equals("万元")){//多指标中单位是万元的转换成元存数据库
									if(jsonObj.get("init_value")!=null && !jsonObj.get("init_value").equals("") ){
										multiTradeMap.put("init_value",Float.parseFloat(jsonObj.get("init_value").toString())*10000);
									}else{
										multiTradeMap.put("init_value",jsonObj.get("init_value"));
									}
									
									if(jsonObj.get("final_value")!=null && !jsonObj.get("final_value").equals("")){
										multiTradeMap.put("final_value",Float.parseFloat(jsonObj.get("final_value").toString())*10000);
									}else{
										multiTradeMap.put("final_value",jsonObj.get("final_value"));
									}
									
									if(jsonObj.get("step")!=null && !jsonObj.get("step").equals("")){
										multiTradeMap.put("step",Float.parseFloat(jsonObj.get("step").toString())*10000);
									}else{
	...
	public ParaMap doCheckTransTarget(ParaMap inMap) throws Exception {
		...
		if (str != null && str.length > 0) {
			for (int i = 0; i < str.length; i++) {
				...
				if (!"1".equals(targetMap.getString("state"))) {
					throw new Exception("审核失败！标的'" + targetNo + "'审核失败。");
				}
			}
			out.put("state", 1);
	 ...
	 * @throws Exception
	 */
	public ParaMap getTransGoodsRelList(ParaMap inMap) throws Exception {
		String userId = inMap.getString("u");
		String organId = this.getOrganId(userId);
		String goods_type = inMap.getString("goods_type");
		String canton_id = inMap.getString("canton_id");
	...
	// public void getCanUpdateStatus(){
	// updateStatus = 2;
	// updateStatusName = "公告";
	// }
